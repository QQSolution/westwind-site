...
export const quiz = {
  ...
  intelliappSources: {
    ...
    tiktok: 'TikTok', 'tiktok-ads': 'TikTok', tt: 'TikTok',
    indeed: 'Indeed', 'indeed-ads': 'Indeed', 'indeed-sponsored': 'Indeed',
    linkedin: 'LinkedIn', li: 'LinkedIn', 'linkedin-ads': 'LinkedIn',
    snapchat: 'Snapchat', snap: 'Snapchat',
    craigslist: 'Craigslist', cl: 'Craigslist',
    dima: 'Dima',
